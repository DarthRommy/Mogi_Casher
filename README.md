...
ゆくゆくはオンライン化を見据えてHTMLに移植してみてる途中。=> [Here](https://github.com/DarthRommy/MogiCasher_HTML)
...
## 機能一覧
- [x] **[CSV形式](/README.md#CSVファイルの形式)** でコードデータを読み込み
...
### 来年は？
優秀なプログラマーの方、ぜひ模擬村にWi-Fiを飛ばしてオンライン化しちゃってください。

まあ効率をよくするならそもそもチケットを挟むのをやめて金で直接っていうのがいいんですけどね  
まあそうはいっても伝統という圧倒的な防壁がありますからね…
